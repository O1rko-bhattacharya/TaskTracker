    ...
    <Navbar/>
      ...
      <h2 className="text-lg font-bold p-1">Add a Task:</h2>
        <div className="add-todo my-4 flex flex-row">
          ...
          <h1 className="text-lg font-bold p-2"><img src="/src/assets/Todoicon.svg" alt="Default" className="w-5 h-5 inline mx-1"></img>Your Todo Tasks:</h1>
        ...
        <br></br>
        <h2 className="text-lg font-bold p-2"><img src="/src/assets/CompletedIcon.svg" alt="Default" className="w-5 h-5 inline mx-1"></img>Completed Tasks:</h2>
